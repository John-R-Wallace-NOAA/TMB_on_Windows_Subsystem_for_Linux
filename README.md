...
https://www.hanselman.com/blog/easily-move-wsl-distributions-between-windows-10-machines-with-import-and-export
     ...
     #     imported it with the command below. Note that the website given above on moving wsl distributions is
     #     outdated and the import format is now: wsl --import <Distro> <InstallLocation> <FileName> [Options] 
